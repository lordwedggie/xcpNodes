...
class xcpIntSlider
{
    constructor(node)
    {
		...
		this.node.properties.buttonColor = "rgba(28,90,180,1.0)";
		this.node.properties.slotColor = "rgba(10,10,10,0.8)";
		this.node.properties.fillBarColor = "rgba(28,90,180,0.5)";
        ...
        this.node.onPropertyChanged = function (propName)
        {
            ...
            if (this.properties.decimals>1) this.properties.decimals = 0;
            ...
            this.outputs[0].type = (this.properties.decimals > 0)?"INT":"INT";
        ...
        this.node.onDrawForeground = function(ctx)
        {
            ...
            ctx.fillText(this.properties.value.toFixed(dgt), this.size[0]-shiftRight+26, shX+(this.properties.labelSize/4));
        }
...
app.registerExtension(
{
    ...
    {
        if (nodeData.name === "xcpIntSlider")
        {
            const onNodeCreated = nodeType.prototype.onNodeCreated;
            nodeType.prototype.onNodeCreated = function () {
                if (onNodeCreated) onNodeCreated.apply(this, []);
                this.xcpIntSlider = new xcpIntSlider(this);
            }
        }
    }
});
